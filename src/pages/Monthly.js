...
import Monthlyadd from './monthlyadd';

// ----------------------------------------------------------------------

const TABLE_HEAD = [
  { id: 'name', label: 'Blend', alignRight: false },
  { id: 'FSO2', label: 'FSO2 (ppm)', alignRight: false },
              ...
              <Table>
                ...
                <TableBody>
                  {filteredUsers.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((row) => {
                    const { id, name, FSO2, VA, Comments } = row;
                    ...
                    return (
                      ...
                      >
                        ...
                        <TableCell align="center">{FSO2}</TableCell>
                        <TableCell align="center" >{VA}</TableCell>
                        <TableCell alignItems="left">{Comments}</TableCell>
